...
| テキスト入力、Dictation、volatile 表示 | `Koecho/VoiceInputTextView.swift`, `Koecho/VoiceInputCoordinator.swift`, `Koecho/DictationEngine.swift` | [音声入力テキストライフサイクル](voice-input-text-lifecycle.md), docs/decisions/0001-auto-start-dictation-via-startdictation-selector.md, docs/decisions/0010-nstextview-subclass-replacing-swiftui-texteditor.md | `KoechoTests/VoiceInputTextViewTests.swift`, `KoechoTests/VoiceInputCoordinatorTests.swift`, `KoechoTests/DictationEngineTests.swift` |
